/**
 * gallery.js â€” MathematicX Computation Gallery
 * Handles: computation data, category filtering, search, card rendering, modal
 *
...
const SIMULATIONS = [
   {
     id: "login-window",
     title: "Login Window",
     desc: "A secure authentication interface that allows users to sign in to the platform, ensuring personalized access to computations, saved progress, and user-specific features.",
     category: "general",
   ...
   },
   {
     ...
     desc: "A visually engaging entry point featuring branding, institutional details, and a direct call-to-action to enter the computation lab.",
     category: "general",
   ...
   },
   {
     ...
     desc: "An introductory interface presenting the platform overview, objectives, and key features, designed to orient users before entering the computation environment.",
     category: "general",
   ...
   {
    id: "main-dashboard",
    title: "Computation Dashboard",
    desc: "The central workspace providing access to mathematics domains, computation statistics, navigation tools, and categorized modules for interactive exploration.",
    category: "general",
  ...
  },
  {
    id: "build-an-atom",
    title: "Build an Atom",
    desc: "An interactive computation that allows users to construct atoms by adding protons, neutrons, and electrons, helping visualize atomic structure, isotopes, and charge balance in real time.",
    category: "nuclear-mathematics",
    badge: { text: "Nuclear Mathematics", cls: "badge-red" },
  ...
  },
  {
    id: "gravitation",
    title: "Gravitation",
    desc: "An interactive computation exploring gravitational forces between masses, allowing users to study orbital motion, inverse-square law behavior, and the dynamics of planetary systems in real time.",
    category: "mechanics",
  ...
  },
  {
    ...
    desc: "An interactive computation that demonstrates the process of radioactive decay, allowing users to explore half-life, decay rates, and the transformation of unstable nuclei over time.",
    category: "nuclear-mathematics",
    badge: { text: "Nuclear Mathematics", cls: "badge-red" },
  ...
  },
  {
    ...
    desc: "A full-featured scientific calculator with history, unit conversion, and support for mathematics constants built right in.",
...
/**
 * Returns the filtered computation list based on
 ...
 * @param {Object} sim â€” computation data object
 * @returns {HTMLElement}
 */
  ...
  if (count) {
    count.textContent =
      sims.length === 0
        ...
        : `Showing ${sims.length} of ${SIMULATIONS.length} computation${sims.length !== 1 ? "s" : ""}`;
  }
  ...
  if (sims.length === 0) {
    grid.innerHTML = `
      <div class="gallery-empty card">
        ...
        <p>No computations available for this filter.</p>
      </div>`;
    return;
  }
