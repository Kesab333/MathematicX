/**
 * contact.js â€” MathematicX Contact Page Logic
 * Handles form validation, submission computation, and reveal animations.
 */
...
(() => {
  ...
  function simulateSubmit(payload) {
    return new Promise((resolve, reject) => {
      console.info('[MathematicX Contact] Payload:', payload);
   ...
   *
   *  MathematicX shared.css handles .reveal/.reveal-delay-* via its own
