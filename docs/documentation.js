/**
 * documentation.js
 * MathematicX documentation page â€” interactive behaviours
 *
 * Features:
      ...
      searchResults.innerHTML = matches
        ...
        .map((item) => {
          ...
          if (excerptIdx !== -1) {
            ...
            excerpt = (start > 0 ? "â€¦" : "") + item.text.slice(start, excerptIdx + query.length + 60) + "â€¦";
          }
          return `
